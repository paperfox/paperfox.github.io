        ...
        <div className="row justify-content-center mb-4">
          <div className="col-xl-5 col-lg-6 col-md-7 col-sm-10">
            <div className="mb-5">
              ...
              <p>Currently I'm working as a developer in the authenticated space of <a href="https://www.massmutual.com/" target="_blank" rel="noreferrer">MassMutual</a> so my site had been looking a bit sparse and neglected. I decided to start building a tarot app since it pulls together my development and design skills, while also giving me a place to showcase my art. Plus, its fun to build with lots of places I can expand it!</p>
            ...
            <div className="mb-5">
              ...
              <ul className="mb-4">
                <li>
                  <a href="https://www.shadowscapes.com/Tarot/cardsmain.php?suit=0" target="_blank" rel="noreferrer">Shadowscapes Tarot Deck</a>
                </li>
                <li>
                  <a href="https://wyrmwoodgaming.com/corrupted-tarot/" target="_blank" rel="noreferrer">Corrupted Tarot Deck</a>
                </li>
                <li>
                  <a href="https://www.tarotcardmeanings.net/" target="_blank" rel="noreferrer">Tarot Card Meanings</a>
                </li>
                <li>
                  <a href="https://labyrinthos.co/blogs/tarot-card-meanings-list" target="_blank" rel="noreferrer">Labyrinthos</a>
                </li>
                <li>
                  <a href="https://www.healthmanifested.com/list-of-tarot-cards-in-order/" target="_blank" rel="noreferrer">Health Manifested</a>
                </li>
                <li>
                  <a href="https://chat.openai.com/" target="_blank" rel="noreferrer">Chat GPT-3</a>
                </li>
              </ul>
              <h3>Images</h3>
