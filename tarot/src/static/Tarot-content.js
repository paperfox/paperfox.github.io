  ...
  return [
    {
      id: 0, 
      title: 'Card Back', 
      uprightCard: 'Should I hide the modal in this state?',
      link: ''
    },
    {
      id: 1, 
    ...
    {id: 22, title: 'The World', uprightCard: 'This is some sample text', link: 'https://www.tarotcardmeanings.net/waite-tarot-comments/waite-on-tarot-world.htm'},
    {
      ...
      reverseCard: 'Beware excess pursuits leading to ruin. Don\'t let joy and revel cloud you to seeing the consequences of your own actions.',
